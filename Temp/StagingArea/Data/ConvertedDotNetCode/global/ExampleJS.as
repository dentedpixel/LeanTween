package global {
	...
	public class ExampleJS extends MonoBehaviour implements IDeserializable {
		...
		public var ExampleJS$moveId$: LTDescr;
		
		public var ExampleJS$pingPongDescr$: LTDescr;
		...
		public function ExampleJS_cycleThroughExamples(): void {
			...
			LeanTween.LeanTween_delayedCall_Single_Action(1.05, this.ExampleJS_cycleThroughExamples).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_updateValue3Example(): void {
			Debug.Debug_Log_Object("updateValue3Example");
			LeanTween.LeanTween_value_GameObject_Action$1_Vector3_Vector3_Single(this.ExampleJS$ltLogo$, this.ExampleJS_updateValue3ExampleCallback_Vector3, new Vector3().Constructor_Single_Single_Single(Number(0), 270, Number(0)), new Vector3().Constructor_Single_Single_Single(30, 270, Number(180)), 0.5).LTDescr_setEase_LeanTweenType(LeanTweenType.easeInBounce).LTDescr_setLoopPingPong().LTDescr_setRepeat_Int32(2).LTDescr_setOnUpdateVector3_Action$1(this.ExampleJS_updateValue3ExampleUpdate_Vector3).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_updateValue3ExampleUpdate_Vector3($val: Vector3): void {
			Debug.Debug_Log_Object("val:" + $val.cil2as::Copy());
		}
		...
		public function ExampleJS_loopTestClamp(): void {
			...
			this.ExampleJS$moveId$ = LeanTween.LeanTween_scaleZ_GameObject_Single_Single($gameObject, 4, 1).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutElastic).LTDescr_setLoopClamp().LTDescr_setRepeat_Int32(7).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_loopTestPingPong(): void {
			...
			var $vector: Vector3 = $gameObject.transform.localScale = $localScale.cil2as::Copy();
			this.ExampleJS$pingPongDescr$ = LeanTween.LeanTween_scaleY_GameObject_Single_Single($gameObject, 4, 1).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutQuad).LTDescr_setRepeat_Int32(8).LTDescr_setLoopPingPong().LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
			Debug.Debug_Log_Object("id:" + this.ExampleJS$pingPongDescr$.LTDescr_id);
		}
		...
		public function ExampleJS_moveOnACurveExample(): void {
			...
			LeanTween.LeanTween_move_GameObject_Vector3Array_Single(this.ExampleJS$ltLogo$, $to, 1).LTDescr_setEase_LeanTweenType(LeanTweenType.easeInQuad).LTDescr_setOrientToPath_Boolean(true).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_punchTest(): void {
			LeanTween.LeanTween_moveX_GameObject_Single_Single(this.ExampleJS$ltLogo$, Number(7), 1).LTDescr_setEase_LeanTweenType(LeanTweenType.punch).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_customTweenExample(): void {
			Debug.Debug_Log_Object("customTweenExample");
			LeanTween.LeanTween_moveX_GameObject_Single_Single(this.ExampleJS$ltLogo$, Number(-10), 0.5).LTDescr_setEase_AnimationCurve(this.ExampleJS$customAnimationCurve$).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
			LeanTween.LeanTween_moveX_GameObject_Single_Single(this.ExampleJS$ltLogo$, Number(0), 0.5).LTDescr_setDelay_Single(0.5).LTDescr_setEase_AnimationCurve(this.ExampleJS$customAnimationCurve$).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_moveExample(): void {
			Debug.Debug_Log_Object("moveExample");
			LeanTween.LeanTween_move_GameObject_Vector3_Single(this.ExampleJS$ltLogo$, new Vector3().Constructor_Single_Single_Single(-2, -1, Number(0)), 0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
			LeanTween.LeanTween_move_GameObject_Vector3_Single(this.ExampleJS$ltLogo$, this.ExampleJS$ltLogo$.transform.position, 0.5).LTDescr_setDelay_Single(0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_rotateExample(): void {
			Debug.Debug_Log_Object("rotateExample");
			LeanTween.LeanTween_rotate_GameObject_Vector3_Single(this.ExampleJS$ltLogo$, new Vector3().Constructor_Single_Single_Single(Number(0), Number(360), Number(0)), 1).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutQuad).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_scaleExample(): void {
			...
			LeanTween.LeanTween_scale_GameObject_Vector3_Single(this.ExampleJS$ltLogo$, new Vector3().Constructor_Single_Single_Single($localScale.x + 0.2, $localScale.y + 0.2, $localScale.z + 0.2), Number(1)).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutBounce).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_updateValueExample(): void {
			Debug.Debug_Log_Object("updateValueExample");
			LeanTween.LeanTween_value_GameObject_Action$1_Single_Single_Single(this.ExampleJS$ltLogo$, this.ExampleJS_updateValueExampleCallback_Single, this.ExampleJS$ltLogo$.transform.eulerAngles.y, 270, Number(1)).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutElastic).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_delayedCallExample(): void {
			...
			LeanTween.LeanTween_delayedCall_Single_Action(0.5, this.ExampleJS_delayedCallExampleCallback).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_delayedCallExampleCallback(): void {
			...
			LeanTween.LeanTween_scale_GameObject_Vector3_Single(this.ExampleJS$ltLogo$, new Vector3().Constructor_Single_Single_Single($localScale.x - 0.2, $localScale.y - 0.2, $localScale.z - 0.2), 0.5).LTDescr_setEase_LeanTweenType(LeanTweenType.easeInOutCirc).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_alphaExample(): void {
			...
			LeanTween.LeanTween_alpha_GameObject_Single_Single($gameObject, Number(0), 0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
			LeanTween.LeanTween_alpha_GameObject_Single_Single($gameObject, 1, 0.5).LTDescr_setDelay_Single(0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_moveLocalExample(): void {
			...
			LeanTween.LeanTween_moveLocal_GameObject_Vector3_Single($gameObject, new Vector3().Constructor_Single_Single_Single(Number(0), 2, Number(0)), 0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
			LeanTween.LeanTween_moveLocal_GameObject_Vector3_Single($gameObject, $localPosition, 0.5).LTDescr_setDelay_Single(0.5).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		
		public function ExampleJS_rotateAroundExample(): void {
			Debug.Debug_Log_Object("rotateAroundExample");
			var $gameObject: GameObject = GameObject.GameObject_Find_String("LCharacter");
			LeanTween.LeanTween_rotateAround_GameObject_Vector3_Single_Single($gameObject, Vector3.up, 360, 1).LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$);
		}
		...
		public function ExampleJS_loopPause(): void {
			this.ExampleJS$moveId$.LTDescr_pause();
		}
		
		public function ExampleJS_loopResume(): void {
			this.ExampleJS$moveId$.LTDescr_resume();
		}
		
		public function ExampleJS_loopCancel(): void {
			this.ExampleJS$pingPongDescr$.LTDescr_cancel();
		}
		...
		public static function get $Type(): Type {
			return _$Type != null ? _$Type : (_$Type = new Type(global.ExampleJS, {"Awake" : "ExampleJS_Awake", "Start" : "ExampleJS_Start", "OnGUI" : "ExampleJS_OnGUI", "cycleThroughExamples" : "ExampleJS_cycleThroughExamples", "updateValue3Example" : "ExampleJS_updateValue3Example", "updateValue3ExampleUpdate" : "ExampleJS_updateValue3ExampleUpdate_Vector3", "updateValue3ExampleCallback" : "ExampleJS_updateValue3ExampleCallback_Vector3", "loopTestClamp" : "ExampleJS_loopTestClamp", "loopTestPingPong" : "ExampleJS_loopTestPingPong", "moveOnACurveExample" : "ExampleJS_moveOnACurveExample", "punchTest" : "ExampleJS_punchTest", "customTweenExample" : "ExampleJS_customTweenExample", "moveExample" : "ExampleJS_moveExample", "rotateExample" : "ExampleJS_rotateExample", "scaleExample" : "ExampleJS_scaleExample", "updateValueExample" : "ExampleJS_updateValueExample", "updateValueExampleCallback" : "ExampleJS_updateValueExampleCallback_Single", "delayedCallExample" : "ExampleJS_delayedCallExample", "delayedCallExampleCallback" : "ExampleJS_delayedCallExampleCallback", "alphaExample" : "ExampleJS_alphaExample", "moveLocalExample" : "ExampleJS_moveLocalExample", "rotateAroundExample" : "ExampleJS_rotateAroundExample", "moveXExample" : "ExampleJS_moveXExample", "rotateXExample" : "ExampleJS_rotateXExample", "scaleXExample" : "ExampleJS_scaleXExample", "loopPause" : "ExampleJS_loopPause", "loopResume" : "ExampleJS_loopResume", "loopCancel" : "ExampleJS_loopCancel", "Main" : "ExampleJS_Main"}, MonoBehaviour.$Type));
		}
