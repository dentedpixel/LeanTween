package global {
	...
	public class ExampleJS extends MonoBehaviour implements IDeserializable {
		...
		public var ExampleJS$pingPongId$: int;
		...
		public function ExampleJS_loopTestPingPong(): void {
			...
			var $vector: Vector3 = $gameObject.transform.localScale = $localScale.cil2as::Copy();
			this.ExampleJS$pingPongId$ = LeanTween.LeanTween_scaleY_GameObject_Single_Single($gameObject, 4, 1).LTDescr_setEase_LeanTweenType(LeanTweenType.easeOutQuad).LTDescr_setRepeat_Int32(8).LTDescr_setLoopPingPong().LTDescr_setUseEstimatedTime_Boolean(this.ExampleJS$useEstimatedTime$).LTDescr_id;
			Debug.Debug_Log_Object("id:" + this.ExampleJS$pingPongId$);
		}
		...
		public function ExampleJS_loopCancel(): void {
			LeanTween.LeanTween_cancel_Int32(this.ExampleJS$pingPongId$);
		}
