package global {
	...
	public class MenuExampleJS extends MonoBehaviour implements IDeserializable {
		...
		public function MenuExampleJS_Start(): void {
			...
			LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleJS$buttonRect2$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(0.55 * this.MenuExampleJS$w$, this.MenuExampleJS$buttonRect2$.LTRect_rect.y)), 0.7, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
		}
		...
		public function MenuExampleJS_OnGUI(): void {
			...
			if (GUI.GUI_Button_Rect_String($position, "Move Cat") && (!LeanTween.LeanTween_isTweening_LTRect(this.MenuExampleJS$grumpyRect$))) {
				var $v: Vector2 = new Vector2().Constructor_Single_Single(this.MenuExampleJS$grumpyRect$.LTRect_rect.x, this.MenuExampleJS$grumpyRect$.LTRect_rect.y);
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleJS$grumpyRect$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single((1 * this.MenuExampleJS$w$) - Number(this.MenuExampleJS$grumpy$.Texture_width), Number(0) * this.MenuExampleJS$h$)), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce));
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleJS$grumpyRect$, Vector2.op_Implicit_Vector2_Vector3($v), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce, "delay", 1));
			}
			...
			if (GUI.GUI_Button_Rect_String(this.MenuExampleJS$buttonRect1$.LTRect_rect, "Scale Centered")) {
				LeanTween.LeanTween_scale_LTRect_Vector2_Single_ObjectArray(this.MenuExampleJS$buttonRect1$, Vector2.op_Multiply_Vector2_Single(new Vector2().Constructor_Single_Single(this.MenuExampleJS$buttonRect1$.LTRect_rect.width, this.MenuExampleJS$buttonRect1$.LTRect_rect.height), 1.2), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleJS$buttonRect1$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(this.MenuExampleJS$buttonRect1$.LTRect_rect.x - (this.MenuExampleJS$buttonRect1$.LTRect_rect.width * 0.1), this.MenuExampleJS$buttonRect1$.LTRect_rect.y - (this.MenuExampleJS$buttonRect1$.LTRect_rect.height * 0.1))), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
			}
			if (GUI.GUI_Button_Rect_String(this.MenuExampleJS$buttonRect2$.LTRect_rect, "Scale")) {
				LeanTween.LeanTween_scale_LTRect_Vector2_Single_ObjectArray(this.MenuExampleJS$buttonRect2$, Vector2.op_Multiply_Vector2_Single(new Vector2().Constructor_Single_Single(this.MenuExampleJS$buttonRect2$.LTRect_rect.width, this.MenuExampleJS$buttonRect2$.LTRect_rect.height), 1.2), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce));
			}
			...
			if (GUI.GUI_Button_Rect_String($position, "Flip Tile")) {
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleJS$beautyTileRect$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(Number(0), this.MenuExampleJS$beautyTileRect$.LTRect_rect.y + Number(1))), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce));
			}
			...
			if (GUI.GUI_Button_Rect_String(this.MenuExampleJS$buttonRect3$.LTRect_rect, "Alpha")) {
				LeanTween.LeanTween_alpha_LTRect_Single_Single_ObjectArray(this.MenuExampleJS$buttonRect3$, Number(0), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
				LeanTween.LeanTween_alpha_LTRect_Single_Single_ObjectArray(this.MenuExampleJS$buttonRect3$, 1, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeInQuad, "delay", 1));
			}
			var $a: Number = 1;
			...
			if (GUI.GUI_Button_Rect_String(this.MenuExampleJS$buttonRect4$.LTRect_rect, "Rotate")) {
				LeanTween.LeanTween_rotate_LTRect_Single_Single_ObjectArray(this.MenuExampleJS$buttonRect4$, 150, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutElastic));
				LeanTween.LeanTween_rotate_LTRect_Single_Single_ObjectArray(this.MenuExampleJS$buttonRect4$, Number(0), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutElastic, "delay", 1));
			}
