package global {
	...
	public class MenuExampleCSharp extends MonoBehaviour implements IDeserializable {
		...
		public function MenuExampleCSharp_Start(): void {
			...
			this.MenuExampleCSharp$buttonRect3$ = new LTRect().LTRect_Constructor_Single_Single_Single_Single(0.35 * this.MenuExampleCSharp$w$, 0 * this.MenuExampleCSharp$h$, 0.3 * this.MenuExampleCSharp$w$, 0.2 * this.MenuExampleCSharp$h$);
			...
			LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleCSharp$buttonRect2$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(0.55 * this.MenuExampleCSharp$w$, this.MenuExampleCSharp$buttonRect2$.LTRect_rect.y)), 0.7, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
		}
		...
		public function MenuExampleCSharp_OnGUI(): void {
			...
			if (GUI.GUI_Button_Rect_String($position, "Move Cat") && (!LeanTween.LeanTween_isTweening_LTRect(this.MenuExampleCSharp$grumpyRect$))) {
				var $v: Vector2 = new Vector2().Constructor_Single_Single(this.MenuExampleCSharp$grumpyRect$.LTRect_rect.x, this.MenuExampleCSharp$grumpyRect$.LTRect_rect.y);
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleCSharp$grumpyRect$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single((1 * Number(Screen.width)) - Number(this.MenuExampleCSharp$grumpy$.Texture_width), 0 * Number(Screen.height))), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce, "onComplete", "catMoved", "onCompleteTarget", super.Component_gameObject));
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleCSharp$grumpyRect$, Vector2.op_Implicit_Vector2_Vector3($v), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "delay", 1, "ease", LeanTweenType.easeOutBounce));
			}
			if (GUI.GUI_Button_Rect_String(this.MenuExampleCSharp$buttonRect1$.LTRect_rect, "Scale Centered")) {
				LeanTween.LeanTween_scale_LTRect_Vector2_Single_ObjectArray(this.MenuExampleCSharp$buttonRect1$, Vector2.op_Multiply_Vector2_Single(new Vector2().Constructor_Single_Single(this.MenuExampleCSharp$buttonRect1$.LTRect_rect.width, this.MenuExampleCSharp$buttonRect1$.LTRect_rect.height), 1.2), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleCSharp$buttonRect1$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(this.MenuExampleCSharp$buttonRect1$.LTRect_rect.x - (this.MenuExampleCSharp$buttonRect1$.LTRect_rect.width * 0.1), this.MenuExampleCSharp$buttonRect1$.LTRect_rect.y - (this.MenuExampleCSharp$buttonRect1$.LTRect_rect.height * 0.1))), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
			}
			if (GUI.GUI_Button_Rect_String(this.MenuExampleCSharp$buttonRect2$.LTRect_rect, "Scale")) {
				LeanTween.LeanTween_scale_LTRect_Vector2_Single_ObjectArray(this.MenuExampleCSharp$buttonRect2$, Vector2.op_Multiply_Vector2_Single(new Vector2().Constructor_Single_Single(this.MenuExampleCSharp$buttonRect2$.LTRect_rect.width, this.MenuExampleCSharp$buttonRect2$.LTRect_rect.height), 1.2), 0.25, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce));
			}
			...
			if (GUI.GUI_Button_Rect_String($position, "Flip Tile")) {
				LeanTween.LeanTween_move_LTRect_Vector3_Single_ObjectArray(this.MenuExampleCSharp$beautyTileRect$, Vector2.op_Implicit_Vector2_Vector3(new Vector2().Constructor_Single_Single(0, this.MenuExampleCSharp$beautyTileRect$.LTRect_rect.y + 1)), 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutBounce));
			}
			...
			if (GUI.GUI_Button_Rect_String(this.MenuExampleCSharp$buttonRect3$.LTRect_rect, "Alpha")) {
				LeanTween.LeanTween_alpha_LTRect_Single_Single_ObjectArray(this.MenuExampleCSharp$buttonRect3$, 0, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutQuad));
				LeanTween.LeanTween_alpha_LTRect_Single_Single_ObjectArray(this.MenuExampleCSharp$buttonRect3$, 1, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeInQuad, "delay", 1));
			}
			...
			if (GUI.GUI_Button_Rect_String(this.MenuExampleCSharp$buttonRect4$.LTRect_rect, "Rotate")) {
				LeanTween.LeanTween_rotate_LTRect_Single_Single_ObjectArray(this.MenuExampleCSharp$buttonRect4$, 150, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutElastic));
				LeanTween.LeanTween_rotate_LTRect_Single_Single_ObjectArray(this.MenuExampleCSharp$buttonRect4$, 0, 1, CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "ease", LeanTweenType.easeOutElastic, "delay", 1));
			}
