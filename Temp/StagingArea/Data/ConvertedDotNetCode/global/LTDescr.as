package global {
	...
	public class LTDescr extends CLIObject {
		...
		public var LTDescr$destroyOnComplete$: Boolean;
		...
		public var LTDescr$onUpdateVector3Object$: Function;
		...
		public function get LTDescr_uniqueId(): int {
			var $num: int = this.LTDescr$type$.value;
			return this.LTDescr$_id$ | ($num << 24);
		}
		...
		override public function toString(): String {
			return StringOperations.String_Concat_ObjectArray(CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), !_Object.Object_op_Inequality_Object_Object(this.LTDescr$trans$, null) ? "gameObject:null" : ("gameObject:" + this.LTDescr$trans$.Component_gameObject), " toggle:", this.LTDescr$toggle$, " passed:", this.LTDescr$passed$, " time:", this.LTDescr$time$, " delay:", this.LTDescr$delay$, " from:", this.LTDescr$from$.cil2as::Copy(), " to:", this.LTDescr$to$.cil2as::Copy(), " type:", this.LTDescr$type$, " useEstimatedTime:", this.LTDescr$useEstimatedTime$, " id:", this.LTDescr_id, " hasInitiliazed:", this.LTDescr$hasInitiliazed$));
		}
		...
		public function LTDescr_reset(): void {
			...
			this.LTDescr$destroyOnComplete$ = false;
		...
		public function LTDescr_setDelay_Single($delay: Number): LTDescr {
			if (this.LTDescr$useEstimatedTime$) {
				this.LTDescr$delay$ = $delay;
			} else {
				this.LTDescr$delay$ = $delay * Time.timeScale;
			}
			return this;
		}
		...
		public function LTDescr_setTo_Vector3($to: Vector3): LTDescr {
			this.LTDescr$to$.cil2as::Assign($to);
			return this;
		}
		
		public function LTDescr_setFrom_Vector3($from: Vector3): LTDescr {
			this.LTDescr$from$.cil2as::Assign($from);
			this.LTDescr$hasInitiliazed$ = true;
			this.LTDescr$diff$.cil2as::Assign(Vector3.op_Subtraction_Vector3_Vector3(this.LTDescr$to$, this.LTDescr$from$));
			return this;
		}
		...
		public function LTDescr_setRepeat_Int32($repeat: int): LTDescr {
			...
			if ((($repeat > 1) && (this.LTDescr$loopType$ == LeanTweenType.once)) || (($repeat < 0) && (this.LTDescr$loopType$ == LeanTweenType.once))) {
		...
		public function LTDescr_setOnComplete_Action$1_Object($onComplete: Function, $onCompleteParam: Object): LTDescr {
			this.LTDescr$onCompleteObject$ = $onComplete;
		...
		public function LTDescr_setDestroyOnComplete_Boolean($doesDestroy: Boolean): LTDescr {
			this.LTDescr$destroyOnComplete$ = $doesDestroy;
			return this;
		}
