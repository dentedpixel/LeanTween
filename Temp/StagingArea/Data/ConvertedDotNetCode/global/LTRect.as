package global {
	...
	public class LTRect extends CLIObject implements IDeserializable {
		...
		public var LTRect$labelStr$: String;
		
		public var LTRect$type$: int;
		
		public var LTRect$style$: GUIStyle;
		
		public var LTRect$color$: Color = Color.white.cil2as::Copy();
		
		public var LTRect$fontScaleToFit$: Boolean;
		
		public var LTRect$texture$: Texture;
		
		public var LTRect$id$: int;
		...
		public function get LTRect_width(): Number {
			return this.LTRect$_rect$.width;
		}
		
		public function set LTRect_width_Single($value: Number): void {
			this.LTRect$_rect$.width = $value;
		}
		
		public function get LTRect_height(): Number {
			return this.LTRect$_rect$.height;
		}
		
		public function set LTRect_height_Single($value: Number): void {
			this.LTRect$_rect$.height = $value;
		}
		...
		public function get LTRect_rect(): Rect {
			...
			if (this.LTRect$fontScaleToFit$) {
				this.LTRect$style$.fontSize = int(this.LTRect$_rect$.height);
			}
		...
		public function LTRect_setStyle_GUIStyle($style: GUIStyle): LTRect {
			this.LTRect$style$ = $style;
			return this;
		}
		
		public function LTRect_setFontScaleToFit_Boolean($fontScaleToFit: Boolean): LTRect {
			this.LTRect$fontScaleToFit$ = $fontScaleToFit;
			return this;
		}
		
		public function LTRect_setColor_Color($color: Color): LTRect {
			this.LTRect$color$.cil2as::Assign($color);
			return this;
		}
		
		override public function toString(): String {
			return StringOperations.String_Concat_ObjectArray(CLIArrayFactory.NewArrayWithElements(Type.ForClass(Object), "x:", this.LTRect$_rect$.x, " y:", this.LTRect$_rect$.y, " width:", this.LTRect$_rect$.width, " height:", this.LTRect$_rect$.height));
		}
		...
		public function Deserialize(reader: SerializedStateReader): void {
			...
			reader.Align();
			this.LTRect$labelStr$ = reader.ReadString();
			this.LTRect$type$ = reader.ReadInt();
			this.LTRect$style$ = reader.ReadIDeserializable(GUIStyle.cil2as::DefaultValue()) as GUIStyle;
			this.LTRect$color$ = Color.cil2as::DefaultValue();
			reader.ReadIDeserializable(this.LTRect$color$);
			this.LTRect$fontScaleToFit$ = reader.ReadBool();
			reader.Align();
			this.LTRect$texture$ = reader.ReadUnityEngineObject() as Texture;
			this.LTRect$id$ = reader.ReadInt();
		}
		...
		public function Serialize(writer: SerializedStateWriter): void {
			...
			writer.Align();
			writer.WriteString(this.LTRect$labelStr$);
			writer.WriteInt(this.LTRect$type$);
			writer.WriteIDeserializable(this.LTRect$style$);
			writer.WriteIDeserializable(this.LTRect$color$);
			writer.WriteBool(this.LTRect$fontScaleToFit$);
			writer.Align();
			writer.WriteUnityEngineObject(this.LTRect$texture$);
			writer.WriteInt(this.LTRect$id$);
		}
		
		public function RemapPPtrs(remapper: PPtrRemapper): void {
			this.LTRect$texture$ = remapper.GetNewInstanceToReplaceOldInstance(this.LTRect$texture$) as Texture;
		}
		
		public static function get $Type(): Type {
			return _$Type != null ? _$Type : (_$Type = new Type(global.LTRect, {"get_x" : "LTRect_x", "set_x" : "LTRect_x_Single", "get_y" : "LTRect_y", "set_y" : "LTRect_y_Single", "get_width" : "LTRect_width", "set_width" : "LTRect_width_Single", "get_height" : "LTRect_height", "set_height" : "LTRect_height_Single", "get_rect" : "LTRect_rect", "set_rect" : "LTRect_rect_Rect", "reset" : "LTRect_reset", "resetForRotation" : "LTRect_resetForRotation", "setStyle" : "LTRect_setStyle_GUIStyle", "setFontScaleToFit" : "LTRect_setFontScaleToFit_Boolean", "setColor" : "LTRect_setColor_Color", "ToString" : "toString"}, CLIObject.$Type));
		}
