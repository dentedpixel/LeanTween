package global {
	...
	public class LTBezierPath extends CLIObject {
		...
		public static function get $Type(): Type {
			return _$Type != null ? _$Type : (_$Type = new Type(global.LTBezierPath, {"point" : "LTBezierPath_point_Single", "place" : ["LTBezierPath_place_Transform_Single", "LTBezierPath_place_Transform_Single_Vector3"], "placeLocal" : ["LTBezierPath_placeLocal_Transform_Single", "LTBezierPath_placeLocal_Transform_Single_Vector3"]}, CLIObject.$Type));
		}
