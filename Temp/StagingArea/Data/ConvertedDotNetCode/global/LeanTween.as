	...
	public class LeanTween extends MonoBehaviour implements IDeserializable {
		...
		public static function LeanTween_init_Int32($maxSimultaneousTweens: int): void {
			if (LeanTween$tweens$ == null) {
				...
				LeanTween$_tweenEmpty$.Object_hideFlags_HideFlags = HideFlags.HideAndDontSave;
		...
		public function LeanTween_OnLevelWasLoaded_Int32($lvl: int): void {
			LTGUI.LTGUI_reset();
		}
				...
				while (($num < LeanTween$tweenMaxSearch$) && ($num < LeanTween$maxTweens$)) {
					if ((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$toggle$) {
						...
						if (_Object.Object_op_Equality_Object_Object(LeanTween$trans$, null)) {
							...
							if ((!LeanTween$tween$.LTDescr$hasInitiliazed$) && (((Number(LeanTween$tween$.LTDescr$passed$) == 0) && (Number(LeanTween$tween$.LTDescr$delay$) == 0)) || (Number(LeanTween$tween$.LTDescr$passed$) > 0))) {
									...
									case TweenAction.ROTATE:
										{
											...
											LeanTween$tween$.LTDescr$to$.cil2as::Assign(new Vector3().Constructor_Single_Single_Single(LeanTween_closestRot_Single_Single(LeanTween$tween$.LTDescr$from$.x, LeanTween$tween$.LTDescr$to$.x), LeanTween_closestRot_Single_Single(LeanTween$tween$.LTDescr$from$.y, LeanTween$tween$.LTDescr$to$.y), LeanTween_closestRot_Single_Single(LeanTween$tween$.LTDescr$from$.z, LeanTween$tween$.LTDescr$to$.z)));
											break;
										}
								...
								LeanTween$tween$.LTDescr$diff$.cil2as::Assign(Vector3.op_Subtraction_Vector3_Vector3(LeanTween$tween$.LTDescr$to$, LeanTween$tween$.LTDescr$from$));
							}
							if (LeanTween$tween$.LTDescr$delay$ <= 0) {
									...
									if (LeanTween$tweenAction$.value >= TweenAction.MOVE.value) {
										if (LeanTween$tween$.LTDescr$animationCurve$ != null) {
											...
											if (LeanTween$tween$.LTDescr$tweenType$ == LeanTweenType.linear) {
												LeanTween$newVect$.cil2as::Assign(new Vector3().Constructor_Single_Single_Single(LeanTween$tween$.LTDescr$from$.x + (LeanTween$tween$.LTDescr$diff$.x * LeanTween$ratioPassed$), LeanTween$tween$.LTDescr$from$.y + (LeanTween$tween$.LTDescr$diff$.y * LeanTween$ratioPassed$), LeanTween$tween$.LTDescr$from$.z + (LeanTween$tween$.LTDescr$diff$.z * LeanTween$ratioPassed$)));
											} else {
												if (LeanTween$tween$.LTDescr$tweenType$.value >= LeanTweenType.linear.value) {
													switch (LeanTween$tween$.LTDescr$tweenType$) {
														...
														case LeanTweenType.punch:
															{
																LeanTween$tween$.LTDescr$animationCurve$ = LeanTween$punch$;
																LeanTween$tween$.LTDescr$to$.cil2as::Assign(Vector3.op_Addition_Vector3_Vector3(LeanTween$tween$.LTDescr$from$, LeanTween$tween$.LTDescr$to$));
																LeanTween$tween$.LTDescr$diff$.cil2as::Assign(Vector3.op_Subtraction_Vector3_Vector3(LeanTween$tween$.LTDescr$to$, LeanTween$tween$.LTDescr$from$));
								...
								if (LeanTween$tween$.LTDescr$onUpdateFloat$ != null) {
									...
									if (LeanTween$tween$.LTDescr$onUpdateFloatObject$ != null) {
										...
										if (LeanTween$tween$.LTDescr$onUpdateVector3Object$ != null) {
											LeanTween$tween$.LTDescr$onUpdateVector3Object$(LeanTween$newVect$.cil2as::Copy(), LeanTween$tween$.LTDescr$onUpdateParam$);
										} else {
							...
							if (LeanTween$isTweenFinished$) {
								...
								if ((LeanTween$tween$.LTDescr$loopType$ == LeanTweenType.once) || (LeanTween$tween$.LTDescr$loopCount$ == 1)) {
									...
									if ((LeanTween$tween$.LTDescr$loopCount$ < 0) && (LeanTween$tween$.LTDescr$type$ == TweenAction.CALLBACK)) {
										if (LeanTween$tween$.LTDescr$onComplete$ != null) {
											LeanTween$tween$.LTDescr$onComplete$();
										} else {
											if (LeanTween$tween$.LTDescr$onCompleteObject$ != null) {
		...
		public static function LeanTween_removeTween_Int32($i: int): void {
			if ((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$toggle$) {
				...
				if ((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$destroyOnComplete$ && ((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$ltRect$ != null)) {
					LTGUI.LTGUI_destroy_Int32((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$ltRect$.LTRect$id$);
				}
		...
		public static function LeanTween_cancel_GameObject_Int32($gameObject: GameObject, $uniqueId: int): void {
			if ($uniqueId >= 0) {
				LeanTween_init();
				var $num: int = $uniqueId & 16777215;
				var $num2: int = $uniqueId >> 24;
				if (_Object.Object_op_Equality_Object_Object((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$trans$, null) || (_Object.Object_op_Equality_Object_Object((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$trans$.Component_gameObject, $gameObject) && ((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$type$ == TweenAction.ValueOf($num2)))) {
					LeanTween_removeTween_Int32($num);
				}
			}
		}
		
		public static function LeanTween_cancel_LTRect_Int32($ltRect: LTRect, $uniqueId: int): void {
			if ($uniqueId >= 0) {
				LeanTween_init();
				var $num: int = $uniqueId & 16777215;
				var $num2: int = $uniqueId >> 24;
				if (((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$ltRect$ == $ltRect) && ((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$type$ == TweenAction.ValueOf($num2))) {
					LeanTween_removeTween_Int32($num);
				}
			}
		}
		...
		public static function LeanTween_pause_Int32($uniqueId: int): void {
			...
			var $num2: int = $uniqueId >> 24;
			if ((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$type$ == TweenAction.ValueOf($num2)) {
				(LeanTween$tweens$.elements[$num] as LTDescr).LTDescr_pause();
			}
		}
		...
		public static function LeanTween_pause_GameObject($gameObject: GameObject): void {
			...
			for (var $i: int = 0; $i < LeanTween$tweenMaxSearch$; $i = $i + 1) {
				if (_Object.Object_op_Equality_Object_Object((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$trans$, $transform)) {
					(LeanTween$tweens$.elements[$i] as LTDescr).LTDescr_pause();
				}
			}
		}
		...
		public static function LeanTween_resume_Int32($uniqueId: int): void {
			...
			var $num2: int = $uniqueId >> 24;
			if ((LeanTween$tweens$.elements[$num] as LTDescr).LTDescr$type$ == TweenAction.ValueOf($num2)) {
				(LeanTween$tweens$.elements[$num] as LTDescr).LTDescr_resume();
			}
		}
		...
		public static function LeanTween_resume_GameObject($gameObject: GameObject): void {
			...
			for (var $i: int = 0; $i < LeanTween$tweenMaxSearch$; $i = $i + 1) {
				if (_Object.Object_op_Equality_Object_Object((LeanTween$tweens$.elements[$i] as LTDescr).LTDescr$trans$, $transform)) {
					(LeanTween$tweens$.elements[$i] as LTDescr).LTDescr_resume();
				}
			}
		}
		...
		public static function LeanTween_delayedCall_Single_Action$1($delayTime: Number, $callback: Function): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr(LeanTween_tweenEmpty, Vector3.zero, $delayTime, TweenAction.CALLBACK, LeanTween_options().LTDescr_setOnComplete_Action$1($callback));
		}
		...
		public static function LeanTween_delayedCall_GameObject_Single_Action$1($gameObject: GameObject, $delayTime: Number, $callback: Function): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr($gameObject, Vector3.zero, $delayTime, TweenAction.CALLBACK, LeanTween_options().LTDescr_setOnComplete_Action$1($callback));
		}
		
		public static function LeanTween_destroyAfter_LTRect_Single($rect: LTRect, $delayTime: Number): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr(LeanTween_tweenEmpty, Vector3.zero, $delayTime, TweenAction.CALLBACK, LeanTween_options().LTDescr_setRect_LTRect($rect).LTDescr_setDestroyOnComplete_Boolean(true));
		}
		...
		public static function LeanTween_move_GameObject_Vector2_Single($gameObject: GameObject, $to: Vector2, $time: Number): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr($gameObject, new Vector3().Constructor_Single_Single_Single($to.x, $to.y, $gameObject.transform.position.z), $time, TweenAction.MOVE, LeanTween_options());
		}
		...
		public static function LeanTween_value_GameObject_Action$1_Single_Single_Single($gameObject: GameObject, $callOnUpdate: Function, $from: Number, $to: Number, $time: Number): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr($gameObject, new Vector3().Constructor_Single_Single_Single($to, 0, 0), $time, TweenAction.CALLBACK, LeanTween_options().LTDescr_setTo_Vector3(new Vector3().Constructor_Single_Single_Single($to, 0, 0)).LTDescr_setFrom_Vector3(new Vector3().Constructor_Single_Single_Single($from, 0, 0)).LTDescr_setOnUpdate_Action$1($callOnUpdate));
		}
		...
		public static function LeanTween_value_GameObject_Action$1_Vector3_Vector3_Single($gameObject: GameObject, $callOnUpdate: Function, $from: Vector3, $to: Vector3, $time: Number): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr($gameObject, $to, $time, TweenAction.VALUE3, LeanTween_options().LTDescr_setTo_Vector3($to).LTDescr_setFrom_Vector3($from).LTDescr_setOnUpdateVector3_Action$1($callOnUpdate));
		}
		...
		public static function LeanTween_value_GameObject_Action$2_Single_Single_Single($gameObject: GameObject, $callOnUpdate: Function, $from: Number, $to: Number, $time: Number): LTDescr {
			return LeanTween_pushNewTween_GameObject_Vector3_Single_TweenAction_LTDescr($gameObject, new Vector3().Constructor_Single_Single_Single($to, 0, 0), $time, TweenAction.CALLBACK, LeanTween_options().LTDescr_setTo_Vector3(new Vector3().Constructor_Single_Single_Single($to, 0, 0)).LTDescr_setFrom_Vector3(new Vector3().Constructor_Single_Single_Single($from, 0, 0)).LTDescr_setOnUpdateObject_Action$2($callOnUpdate));
		}
