package global {
	...
	public class ExampleCSharp extends MonoBehaviour implements IDeserializable {
		...
		public function ExampleCSharp_endlessCallback(): void {
			Debug.Debug_Log_Object("endless");
		}
		...
		public function ExampleCSharp_cycleThroughExamples(): void {
			...
			Debug.Debug_Log_Object("cycleThroughExamples time:" + Time.time);
			var $delayTime: Number = this.ExampleCSharp$useEstimatedTime$ || (this.ExampleCSharp$exampleIter$ != 0) ? 1.1 : Time.timeScale;
			LeanTween.LeanTween_delayedCall_GameObject_Single_Action(super.Component_gameObject, $delayTime, this.ExampleCSharp_cycleThroughExamples).LTDescr_setUseEstimatedTime_Boolean(this.ExampleCSharp$useEstimatedTime$);
