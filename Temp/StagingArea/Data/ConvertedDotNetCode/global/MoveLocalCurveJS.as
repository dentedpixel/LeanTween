package global {
	...
	public class MoveLocalCurveJS extends MonoBehaviour implements IDeserializable {
		...
		public function MoveLocalCurveJS_moveOnACurveExample(): void {
			...
			LeanTween.LeanTween_moveLocal_GameObject_Vector3Array_Single(this.MoveLocalCurveJS$ltLogo$, $to, 3).LTDescr_setEase_LeanTweenType(LeanTweenType.easeInQuad).LTDescr_setOrientToPath_Boolean(true).LTDescr_setUseEstimatedTime_Boolean(this.MoveLocalCurveJS$useEstimatedTime$);
		}
